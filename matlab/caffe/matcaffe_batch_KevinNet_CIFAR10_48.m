function [KevinCIFAR48_scores ,KevinCIFAR48_list_im] = matcaffe_batch_KevinNet_CIFAR10_48(y_ft_list_im, use_gpu)
...
if exist('use_gpu', 'var')
  matcaffe_init_KevinNet_CIFAR10_48(use_gpu);
else
  matcaffe_init_KevinNet_CIFAR10_48();
end
